...
use crate::{
    ...
    task::{
        change_program_brk, current_task_memory_set, current_user_token, exit_current_and_run_next,
        get_current_task_info, get_current_task_start_time, suspend_current_and_run_next,
        TaskStatus,
    },
...
pub fn sys_get_time(ts: *mut TimeVal, _tz: usize) -> isize {
    ...
    let mut time: *mut u8 = &time as *const _ as *mut u8;
...
pub fn sys_task_info(_ti: *mut TaskInfo) -> isize {
    ...
    let mut task_info: *mut u8 = task_info as *const _ as *mut u8;
    let buffers = translated_byte_buffer(
        current_user_token(),
        _ti as *mut u8,
